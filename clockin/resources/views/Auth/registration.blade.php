...
<head>
  ...
  <title>Webengy Clockin - User Registration</title>
      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
        <div class="card border border-light-subtle rounded-3 shadow-sm">
          <div class="card-body p-3 p-md-4 p-xl-5">
            ...
            <h1 class="text-center">Benutzer Erstellen</h1>
              ...
              <div class="row gy-2 overflow-hidden">
                <div class="col-12">
                  <div class="form-floating mb-3">
                    ...
                    <label for="name" class="form-label">{{ __('Name & Nachname') }}</label>
                  </div>
                  @error('name')
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    ...
                    <label for="password_confirmation" class="form-label">{{ __('Passwort Bestätigen') }}</label>
                  </div>
                ...
                <div class="col-12">
                  <div class="d-grid my-3">
                    <button class="btn btn-primary btn-lg" type="submit">{{ __('Registrieren') }}</button>
                  </div>
                </div>
                <div class="col-12">
                  <p class="m-0 text-secondary text-center">Sie haben bereits einen Account? <a href="{{ route('login') }}" class="link-primary text-decoration-none"> Anmelden</a></p>
                </div>
              </div>
            </form>
          </div>
